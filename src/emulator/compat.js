const MESSAGES = {
  ...
  locksUpPlaying: 'Game locks up when playing.',
...
const OTHER_VERS = {
  ...
  excite:
    'Other USA versions and releases for other regions (Europe, Japan) appear to work correctly.',
};
...
const ISSUES = {
  ...
  '266c0989ed0929df499389954779ea97': [M.locksUpPlaying], // USA
  '69cc951520ccee8c99f28e086ba6baaa': [M.locksUpPlaying], // USA
