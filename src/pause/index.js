...
export class N64PauseScreen extends Component {
  ...
  render() {
    ...
    const { appProps, closeCallback, emulator, exitCallback, isEditor } = this.props;
          ...
          <CustomPauseScreen
            ...
            additionalButtons={[
              ...
              <PauseScreenButton
                ...
                label="N64 Settings"
                onHandlePad={(focusGrid, e) => focusGrid.moveFocus(e.type, ADDITIONAL_BUTTON_REFS[1])}
                onClick={() => { this.setState({ mode: ModeEnum.N64_SETTINGS }) }}
              />
            ]}
          />
        ) : null)}
